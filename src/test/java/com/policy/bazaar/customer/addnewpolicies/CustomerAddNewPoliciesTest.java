package com.policy.bazaar.customer.addnewpolicies;
...
public class CustomerAddNewPoliciesTest {
	...
	public void addNewIsSuccess() {
		...
		CustomerAddNewPoliciesMock custMock = new CustomerAddNewPoliciesMock();
		{
			custMock.setPid(503);
			custMock.setCid(2017);
		}
		
		try {

			MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post("/customers/addpolicies")
					.content(toJsonString(custMock)).contentType(MediaType.APPLICATION_JSON)
